...
const ExpertsList = () => {
  const [selectedExpert, setSelectedExpert] = useState(experts[0]) as any;
  ...
  return (
    <div className="flex flex-wrap p-1">
      <div
        className={`w-full md:w-1/3 p-4 overflow-auto ${
          selectedExpert ? "order-2 md:order-1" : ""
        }`}
      ...
      <div
        ref={detailViewRef}
        className={`w-full md:w-2/3 p-4 flex justify-center ${
          selectedExpert ? "order-1 md:order-2" : ""
        }`}
      >
        {selectedExpert ? (
          <div className="p-6 bg-white border rounded-lg shadow w-full text-center md:text-left">
            ...
            <div className="mb-4 flex justify-center md:justify-start">
              <a
                href={selectedExpert.socialMedia.linkedin}
                target="_blank"
              ...
              <a
                href={selectedExpert.socialMedia.twitter}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mx-2 text-blue-400"
              >
                <FaTwitter size={24} />
              </a>
              <a
                href={selectedExpert.socialMedia.facebook}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mx-2 text-blue-800"
              >
                <FaFacebook size={24} />
              </a>
              <a
                href={selectedExpert.socialMedia.reddit}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mx-2 text-orange-500"
              >
                <FaReddit size={24} />
              </a>
              <a
                href={selectedExpert.socialMedia.github}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mx-2 text-black"
              >
                <FaGithub size={24} />
              </a>
            </div>
            <p className="text-gray-800 mb-2">
              <strong>Experience:</strong> {selectedExpert.experience}
            </p>
            <p className="text-gray-800 mb-2">
              <strong>Interests:</strong> {selectedExpert.interests}
            </p>
            <p className="text-gray-800 mb-2">
              <strong>Papers Published:</strong>{" "}
              {selectedExpert.papers.join(", ")}
            </p>
            <p className="text-gray-800 mb-4">
              <strong>Projects Worked On:</strong>{" "}
              {selectedExpert.projects.join(", ")}
            </p>
          ...
          <div className="flex flex-col items-center justify-center text-center w-full">
            ...
            <p className="italic text-gray-500 m-4">
              Select an expert to see detailed information
            </p>
          </div>
        )}
      </div>
